...
/*the variable "environment" is a pointer pointing to an array of pointers, each of which points to strings*/
extern char **environ;


/**
 * @struct data - A structure that holds various runtime data.
